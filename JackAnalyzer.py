...
def analyze_file(
    ...
    # comilation_engine = CompilationEngine(tokenizer, output_file)

    # remember that in the videos the teacher said that we should write <tokens> at the first and
    # the end of the  translated file... // ask about it.
